...
vary knob function [n] start_frame end_frame start_val end_val
			- vary a knob from start_val to end_val over
			  the course of start_frame to end_frame
			- function is "linear", "exponential", "polynomial"
			- if the latter two, an additional arg n specifies the base
...
Lighting
--------
light name r g b x y z  	- creates a "light" datastructure with rgb values and name
